...
class Algo(BaseAlgo):
    ...
    def learn(self, list_sample_data):
        """
        使用给定的数据更新Q表格:
        list_sample_data:每个样本的格式均是(state, action, reward, next_state, next_action, done)
        使用以下公式更新Q值:
        ...
        next_state, next_action, done = sample.next_state, sample.next_action, sample.done
