class Config:
    gamma = 0.99                           # 折扣因子
    lambd = 0.95                           # GAE平滑系数
    L2_reg = 1e-3                          # critic中 L2正则化系数
    actor_hidden_layers = (150,150)        # actor各个隐藏层的网络规模
    critic_hidden_layers = (150,150)       # critic各个隐藏层的网络规模
    actor_learning_rate = 2e-4             # actor模型学习率
    critic_learning_rate = 2e-4            # critic模型学习率
