...
class Agent:
    def __init__(self,env):
        ...
        self.config.max_action = self.max_action
        self.config.target_policy_noise = 0.2 * self.max_action
        self.config.target_policy_noise_clip = 0.5 * self.max_action
